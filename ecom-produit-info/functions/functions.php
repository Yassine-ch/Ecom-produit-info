...
function getpro(){
    ...
    while($row_pro = mysqli_fetch_array($run_pro)){
        ...
        $product_image = $row_pro['prd_img'];
          ...
          /*echo "<img src = 'admin/product_images/$row_pro[prd_img]' height=110 width=90>";*/
        ...
        <div class='center_prod_box'>
          ...
          <div class='product_img'><a href='details.php?pro_id=$product_id'><img src='admin/product_images/$product_image' alt='' border='0' width='90' height='110' /></a></div>
          <div class='prod_price'><span class='price'>Dt $product_price</span></div>
        </div>
...
function sliderdata(){
    ...
    $get_pro = "select * from produits order by RAND() LIMIT 0,1";
    $run_pro = mysqli_query($con,$get_pro);
    ...
    while($row_pro = mysqli_fetch_array($run_pro)){
        ...
        <div class='oferta_content'> <img src='admin/product_images/$product_image' width='94' height='92' alt='' border='0' class='oferta_img' />
...
function details(){
    ...
    $get_pro = "select * from produits where prd_id = '$prod_id'";
    $run_pro = mysqli_query($con,$get_pro);
    ...
    echo"
        ...
        <div class='center_prod_box_big'>
          <div class='product_img_big'> <a href='javascript:popImage('admin/product_images/$product_image','Some Title')' title='header=[<img src=admin/product_images/$product_image>] body=[&nbsp;] fade=[on]'><img src='admin/product_images/$product_image' height=200 width=185 alt='' border='0' /></a>
            </div>
          <div class='details_big_box'>
            ...
            <div class='prod_price_big'> <span class='price'>Dt $product_price</span></div>
...
function get_pro_cat(){
    ...
    $get_pro_cat = "select * from produits where prd_cat ='$cat_id' ";
...
function get_pro_brand(){
    ...
    $get_pro = "select * from produits where prd_brand = '$brand_id'";
    $run_pro = mysqli_query($con,$get_pro);
...
function getpro3(){
    ...
    $get_pro = "select * from produits order by RAND() LIMIT 0,3";
    $run_pro = mysqli_query($con,$get_pro);
